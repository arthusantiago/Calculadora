...
public class CalcModelo2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.calcmodelo2);
    ...
    View.OnClickListener ouvinteSomar = new View.OnClickListener()
    {
        ...
        {
            //mensagem de alerta;
            diag_mensagem = new AlertDialog.Builder(CalcModelo2.this);
            ...
            if(objcalc.getCampo1().getText().toString().trim().equals("") && objcalc.getCampo2().getText().toString().trim().equals(""))
            {
                ...
                if(TextUtils.isEmpty(objcalc.getCampo1().getText().toString())){
                    ...
                    diag_mensagem.setMessage("Você não marcou o checkbox para poder calcular");
                    diag_mensagem.setNeutralButton("OK",null);
                    diag_mensagem.show();
                }
            }
    ...
    {
        public void onClick (View v) {
            Intent intent = new Intent(CalcModelo2.this,TelaHistorico.class);
    ...
    View.OnClickListener ouvinteVoltar = new View.OnClickListener()
    {
        @Override
        public void onClick (View v) {
            Intent intent = new Intent(CalcModelo2.this,Principal.class);
            startActivity(intent);
        };
    };
}
