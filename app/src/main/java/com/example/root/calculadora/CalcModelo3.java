...
public class CalcModelo3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.calcmodelo3);
        ...
        //Escutando os "Clicks" do botão e executando alguma função;
    ...
    View.OnClickListener ouvinteSomar = new View.OnClickListener()
    {
        ...
        {
            //mensagem de alerta;
            diag_mensagem = new AlertDialog.Builder(CalcModelo3.this);
    ...
    {
        public void onClick (View v) {
            Intent intent = new Intent(CalcModelo3.this,TelaHistorico.class);
    ...
    View.OnClickListener ouvinteVoltar = new View.OnClickListener()
    {
        @Override
        public void onClick (View v) {
            Intent intent = new Intent(CalcModelo3.this,Principal.class);
            startActivity(intent);
        };
    };
}
